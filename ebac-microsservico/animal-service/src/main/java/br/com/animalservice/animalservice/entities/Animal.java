package br.com.animalservice.animalservice.entities;

import br.com.animalservice.animalservice.enums.AnimalsType;
...
public class Animal {
    ...
    private AnimalsType tipoAnimal;
    ...
    public AnimalsType getTipoAnimal() {
        return tipoAnimal;
    }

    public void setTipoAnimal(AnimalsType tipoAnimal) {
